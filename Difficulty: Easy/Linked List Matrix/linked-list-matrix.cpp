...
class Solution {
  public:
    Node* constructLinkedMatrix(vector<vector<int>>& mat) {
        ...
        // Create a 2D array of Node* to keep track of all nodes
        ...
        // Set right and down pointers for each node
        for (int i = 0; i < n; ++i) {
            for (int j = 0; j < n; ++j) {
                if (j < n - 1) {
        ...
        // Return the top-left node, which is the head of the linked list
        return nodes[0][0];
    }
};
