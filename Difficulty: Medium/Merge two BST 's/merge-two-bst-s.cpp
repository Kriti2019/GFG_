...
class Solution {
public:
    // Helper function to perform an in-order traversal of the BST and store values in a vector
    ...
    vector<int> merge(Node *root1, Node *root2) {
        vector<int> bst1Elements;
        vector<int> bst2Elements;
        
        // Get sorted elements from both BSTs using in-order traversal
        inorderTraversal(root1, bst1Elements);
        inorderTraversal(root2, bst2Elements);
        
        // Merge the two sorted vectors
        return mergeSortedVectors(bst1Elements, bst2Elements);
    }
};
